    ...
    <Layout>
      ...
      <section className="container-page py-20 border-b border-hairline">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-5 text-lg leading-relaxed text-muted-foreground whitespace-pre-line">
            {editorialNote}
          </div>
        </div>
      </section>
      ...
      <section className="container-page py-20">
        ...
        <div className="space-y-20">
          {mentors.map((m) => (
            <article key={m.name} className="grid lg:grid-cols-12 gap-12 border-t border-hairline pt-12">
